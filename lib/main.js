...
const Foxes_1 = __importDefault(require("./pages/Foxes"));
...
(async () => {
    ...
    let team;
    let gallary;
    skynode_1.BodyNode.append((0, skynode_1.el)("header", (0, skynode_1.el)("a.logo", (0, skynode_1.el)("img", { src: "/images/0.png", height: "60" }), (0, skynode_1.el)("h1", "FoxPunks"), { click: () => scrollTo(0, 0) }), (0, skynode_1.el)("a.pc-menu", "Roadmap", {
