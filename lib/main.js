...
(async () => {
    ...
    }), (0, skynode_1.el)("a.mobile-menu", (0, skynode_1.el)("i.fas.fa-bars"), {})), new Intro_1.default(), mint = new Mint_1.default(), roadmap = new Roadmap_1.default(), team = new Team_1.default(), gallary = new Gallary_1.default(), (0, skynode_1.el)("footer", "© 2021 FoxPunks LLC"));
})();
